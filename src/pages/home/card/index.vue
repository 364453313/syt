    ...
    <el-card class="box-card" shadow="hover">
        <div class="content">
            <div class="left">
                ...
                <div class="tip">
                    <div class="level">
                        <svg t="1690689254807" class="icon" viewBox="0 0 1024 1024" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" p-id="1467" width="16" height="16">
                            <path
